package com.practical_research.maxProductSubset;
...
public class MaxProductSubset {
	...
	static int maxProductSubset_Module(int a[], int n)
	{
		if(n == 1)
			return a[0];
	...
	public static void main(String[] args) {
		...
		int a[] = {-1, -1, -2, 4, 3};
		int n = a.length;
		System.out.println(maxProductSubset_Module(a, n));   //output: 24 for array above
	}
